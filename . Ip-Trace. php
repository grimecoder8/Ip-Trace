...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mTool Name \033[01;37m:- \033[01;36mIp-Trace
         \033[01;33mAuthor \033[01;37m:- \033[01;36mgrimecoder8
         \033[01;33mPowered By \033[01;37m:- \033[01;36mCodex

 \033[01;33mIp-Trace\033[01;32m is use \033[01;36mip-api \033[01;32mto retrive any ip address information. My system will automatically ban any IP addresses doing over 150 requests per minute.\033[00m
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone git clone https://github.com/grimecoder8/Ip-Trace.git");
  system("cd ~/ && sudo git clone git clone https://github.com/grimecoder8/Ip-Trace.git");
  system("cd ~/Ip-Trace && sh install");
  logo();
  echo "\n\033[01;32m              Ip-Trace updated !!!\033[01;37m\n";
  sleep(1);
  menu();
}
